...
class DoubleMa(Strategy):
    ...
    def on_bar(self, bar: Bar):
        ...
        if not (self.last_fast_ema and self.last_slow_ema):
            return 
        cross_over  = self.fast_ema.value > self.slow_ema.value and self.last_fast_ema < self.last_slow_ema 
        cross_below = self.fast_ema.value < self.slow_ema.value and self.last_fast_ema >  self.last_slow_ema 
